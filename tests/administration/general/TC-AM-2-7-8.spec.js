...
let TEMPLATE_UUID;
let CLONED_TEMPLATE_UUID;

test.describe.serial("Administration - Notification Template CRUD", () => {
  ...
  test.beforeEach(async ({ authentication }) => {
    ...
    await admin.navigateToNotificationTemplate();
  ...
  test("Create Notification Template", async ({ authentication }) => {
    ...
    await admin.fillNotificationTemplateCreateForm({
    ...
    TEMPLATE_UUID = await admin.getUUIDFromView();

    expect(TEMPLATE_UUID).toBeTruthy();
  ...
  test("View", async ({ authentication }) => {
    ...
    await common.searchByUUID(TEMPLATE_UUID);
  ...
  test("Clone", async ({ authentication }) => {
    ...
    CLONED_TEMPLATE_UUID = uuid;

    expect(CLONED_TEMPLATE_UUID).toBeTruthy();
  ...
  test("Delete", async ({ authentication }) => {
    ...
    await common.searchByUUID(CLONED_TEMPLATE_UUID);
